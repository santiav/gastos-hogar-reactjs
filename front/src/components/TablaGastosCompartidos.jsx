                     ...
                     datos.datos.length > 0
                        ...
                        {datos.datos.map(gasto => (
                           <div className="odd:bg-white even:bg-slate-100" key={gasto.id}>
                              <div
                                 className="gasto grid gap-x-1 md:gap-x-3 grid-cols-[60px_minmax(100px,_55%)_25%_20%] md:grid-cols-[60px_minmax(100px,_50%)_16.66%_16.66%_16.66%] py-[8px] grid-rows-[30px] ">
